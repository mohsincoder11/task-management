...
<ul id="task-list" class="list-group">
    ...
    >
            ...
            <div class="flex-grow-1">
                <div class="fw-bold {{ $task->is_completed ? 'text-decoration-line-through text-muted' : '' }}">{{ $task->title }}</div>
            ...
            <div class="ms-3">
                ...
                <form action="{{ route('tasks.destroy', $task) }}" method="POST" style="display:inline" onsubmit="return confirm('Delete task?')">
                    @csrf
                    @method('DELETE')
